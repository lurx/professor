...
const VERSIONS: IVersion[] = [
  {
    number: 1,
    contributor: 1,
    text: "שינוי באופן ייצור מזהיי הלוחות. מהיום, המזהה של הלוח כבר לא יהיה מספר אקראי בן 4 ספרות אלא מספר רץ. כרגע אין כוונה לשנות את מספרי הלוחות שכבר קיימים.",
  },
  {
    number: 2,
    contributor: 4,
    text: "מהיום אפשר להוסיף ללוחות רמז! את הרמזים מזינים בטופס יצירת הלוח, והאפשרות לקבל רמז תופיע 2 דקות לאחר מציאת כל הרביעיות",
  },
  {
    number: 3,
    contributor: 2,
    text: ".אהבתם לוח? מהיום אפשר לתת לו 😍 ובכך לסמן למשתמשים אחרים שהלוח הזה טוב (האפשרות תופיע בסיום הלוח) ",
  },
  {
    number: 4,
    contributor: 5,
